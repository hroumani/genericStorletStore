...
public class calcEmulStorlet implements IStorlet 
{
    @Override
    public void invoke( ArrayList<StorletInputStream>  inputStreams,
    	...
    	//log.emitLog("IdentityStorletHamdi Invoked");
      ...
      int countTest = 0;
		...
		try {
            ...
            double outputStringInt = eval(readString);

            String outputString = new Double(outputStringInt).toString();
		...
		//log.emitLog("IdentityStorletHamdi Invocation done");
    }
